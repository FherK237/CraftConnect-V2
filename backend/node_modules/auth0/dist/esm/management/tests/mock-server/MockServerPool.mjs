...
import { randomBaseUrl } from "./randomBaseUrl.mjs";
        ...
        try {
            ...
            try {
                ...
                if (contentType === null || contentType === void 0 ? void 0 : contentType.includes("application/json")) {
                    body = toJson(fromJson(yield clone.text()), undefined, 2);
                }
                else if (clone.body) {
...
class MockServerPool {
    ...
    createServer(options) {
        const baseUrl = (options === null || options === void 0 ? void 0 : options.baseUrl) || randomBaseUrl();
