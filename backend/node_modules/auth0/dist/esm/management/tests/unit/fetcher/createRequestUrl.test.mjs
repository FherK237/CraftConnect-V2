import { createRequestUrl } from "../../../../../src/management/core/fetcher/createRequestUrl.mjs";
describe("Test createRequestUrl", () => {
    ...
    it("should handle object query parameters", () => {
        ...
        expect(createRequestUrl(baseUrl, queryParams)).toBe("https://api.example.com?filter%5Bname%5D=John&filter%5Bage%5D=30");
    });
    it("should handle mixed types of query parameters", () => {
        ...
        expect(createRequestUrl(baseUrl, queryParams)).toBe("https://api.example.com?simple=value&array=x&array=y&object%5Bkey%5D=value");
    });
    ...
    it("should handle numeric values", () => {
        ...
        expect(createRequestUrl(baseUrl, queryParams)).toBe("https://api.example.com?count=42&price=19.99&active=1&inactive=0");
    });
    ...
    it("should handle null and undefined values", () => {
        ...
        expect(createRequestUrl(baseUrl, queryParams)).toBe("https://api.example.com?valid=value&nullValue=&emptyString=");
    });
    it("should handle deeply nested objects", () => {
        ...
        expect(createRequestUrl(baseUrl, queryParams)).toBe("https://api.example.com?user%5Bprofile%5D%5Bname%5D=John&user%5Bprofile%5D%5Bsettings%5D%5Btheme%5D=dark");
    });
    it("should handle arrays of objects", () => {
        ...
        expect(createRequestUrl(baseUrl, queryParams)).toBe("https://api.example.com?users%5Bname%5D=John&users%5Bage%5D=30&users%5Bname%5D=Jane&users%5Bage%5D=25");
    });
    it("should handle mixed arrays", () => {
        ...
        expect(createRequestUrl(baseUrl, queryParams)).toBe("https://api.example.com?mixed=string&mixed=42&mixed=true&mixed%5Bkey%5D=value");
    });
    ...
    it("should handle special characters in keys", () => {
        ...
        expect(createRequestUrl(baseUrl, queryParams)).toBe("https://api.example.com?key%20with%20spaces=value&key%5Bwith%5Dbrackets=value");
    });
