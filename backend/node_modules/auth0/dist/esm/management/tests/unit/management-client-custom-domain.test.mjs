...
import { ManagementClient } from "../../wrapper/ManagementClient.mjs";
describe("ManagementClient with custom domain header", () => {
    ...
    describe("constructor", () => {
        ...
        it("should create client with custom domain header", () => {
            const clientWithCustomDomain = new ManagementClient(Object.assign(Object.assign({}, mockConfig), { withCustomDomainHeader: "auth.example.com" }));
    ...
    describe("telemetry integration", () => {
        it("should preserve telemetry when using custom domain header", () => {
            const client = new ManagementClient(Object.assign(Object.assign({}, mockConfig), { withCustomDomainHeader: "auth.example.com", telemetry: true, clientInfo: { name: "test-client", version: "1.0.0" } }));
            expect(client).toBeInstanceOf(ManagementClient);
        });
        it("should work with telemetry disabled and custom domain header", () => {
            const client = new ManagementClient(Object.assign(Object.assign({}, mockConfig), { withCustomDomainHeader: "auth.example.com", telemetry: false }));
            expect(client).toBeInstanceOf(ManagementClient);
        });
    });
    describe("configuration validation", () => {
        it("should throw error for invalid custom domain header", () => {
            expect(() => {
                new ManagementClient(Object.assign(Object.assign({}, mockConfig), { withCustomDomainHeader: "" }));
        ...
        it("should trim and accept valid custom domain header", () => {
            const client = new ManagementClient(Object.assign(Object.assign({}, mockConfig), { withCustomDomainHeader: "  auth.example.com  " }));
            expect(client).toBeInstanceOf(ManagementClient);
        });
    });
    ...
    describe("custom fetcher integration", () => {
        it("should work with both custom fetcher and custom domain header", () => {
            ...
            const client = new ManagementClient(Object.assign(Object.assign({}, mockConfig), { withCustomDomainHeader: "auth.example.com", fetcher: mockCustomFetcher }));
            expect(client).toBeInstanceOf(ManagementClient);
        });
        it("should create client with custom fetcher but without custom domain header", () => {
            ...
            // TODO: Casting to any to bypass type checks for testing purposes.
            // This is done only because the fetcher type is being hidden for now.
            const client = new ManagementClient(Object.assign(Object.assign({}, mockConfig), { fetcher: mockCustomFetcher }));
            expect(client).toBeInstanceOf(ManagementClient);
        });
    });
});
