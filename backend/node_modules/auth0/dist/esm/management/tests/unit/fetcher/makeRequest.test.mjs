...
import { makeRequest } from "../../../../../src/management/core/fetcher/makeRequest.mjs";
describe("Test makeRequest", () => {
    ...
    it("should handle POST request correctly", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield makeRequest(mockFetch, mockPostUrl, "POST", mockHeaders, mockBody);
    ...
    it("should handle GET request correctly", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield makeRequest(mockFetch, mockGetUrl, "GET", mockHeaders, undefined);
        const responseBody = yield response.json();
        expect(responseBody).toEqual({ test: "successful" });
        expect(mockFetch).toHaveBeenCalledTimes(1);
        const [calledUrl, calledOptions] = mockFetch.mock.calls[0];
