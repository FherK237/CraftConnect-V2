import { toQueryString } from "../../../../../src/management/core/url/index.mjs";
describe("Test qs toQueryString", () => {
    ...
    describe("Nested objects", () => {
        ...
        it("should handle deeply nested objects", () => {
            ...
            expect(toQueryString(obj)).toBe("user%5Bprofile%5D%5Bname%5D=John&user%5Bprofile%5D%5Bsettings%5D%5Btheme%5D=dark");
        });
    ...
    describe("Mixed scenarios", () => {
        it("should handle complex nested structures", () => {
            ...
            expect(toQueryString(obj)).toBe("filters%5Bstatus%5D%5B0%5D=active&filters%5Bstatus%5D%5B1%5D=pending&filters%5Bcategory%5D%5Btype%5D=electronics&filters%5Bcategory%5D%5Bsubcategories%5D%5B0%5D=phones&filters%5Bcategory%5D%5Bsubcategories%5D%5B1%5D=laptops&sort%5Bfield%5D=name&sort%5Bdirection%5D=asc");
        });
        it("should handle complex nested structures with repeat format", () => {
            ...
            expect(toQueryString(obj, { arrayFormat: "repeat" })).toBe("filters%5Bstatus%5D=active&filters%5Bstatus%5D=pending&filters%5Bcategory%5D%5Btype%5D=electronics&filters%5Bcategory%5D%5Bsubcategories%5D=phones&filters%5Bcategory%5D%5Bsubcategories%5D=laptops&sort%5Bfield%5D=name&sort%5Bdirection%5D=asc");
        });
