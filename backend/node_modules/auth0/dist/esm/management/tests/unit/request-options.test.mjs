...
import { CustomDomainHeader, withTimeout, withRetries, withHeaders, withAbortSignal, withCustomDomainHeader, } from "../../request-options.mjs";
describe("request-options", () => {
    ...
    describe("withCustomDomainHeader", () => {
        ...
        describe("input validation", () => {
            ...
            it("should throw error for null domain", () => {
                expect(() => {
                    withCustomDomainHeader(null, mockClientOptions);
                }).toThrow("Domain parameter is required and must be a non-empty string");
            });
            it("should throw error for undefined domain", () => {
                expect(() => {
                    withCustomDomainHeader(undefined, mockClientOptions);
                }).toThrow("Domain parameter is required and must be a non-empty string");
            });
        ...
        describe("fetcher functionality", () => {
            ...
            it("should create custom fetcher that validates URL arguments", () => __awaiter(void 0, void 0, void 0, function* () {
                const result = withCustomDomainHeader("auth.example.com", mockClientOptions);
                yield expect(result.fetcher({ url: "", method: "GET" })).rejects.toThrow("Invalid fetcher arguments: URL is required");
            }));
            it("should handle invalid URLs gracefully", () => __awaiter(void 0, void 0, void 0, function* () {
                const result = withCustomDomainHeader("auth.example.com", mockClientOptions);
            ...
            it("should preserve existing options and add fetcher", () => {
                const options = Object.assign(Object.assign({}, mockClientOptions), { customProperty: "test-value", timeout: 30 });
                const result = withCustomDomainHeader("auth.example.com", options);
                expect(result).toEqual(Object.assign(Object.assign({}, options), { fetcher: expect.any(Function) }));
            });
        });
        ...
        describe("custom fetcher chaining", () => {
            it("should chain with existing custom fetcher", () => __awaiter(void 0, void 0, void 0, function* () {
                const mockCustomFetcher = jest.fn().mockResolvedValue({
                    ok: true,
                    body: { data: "custom-result" },
                    headers: {},
                });
                const optionsWithCustomFetcher = Object.assign(Object.assign({}, mockClientOptions), { fetcher: mockCustomFetcher });
                ...
                yield result.fetcher(args);
                // Verify that the original custom fetcher was called with the custom domain header
                expect(mockCustomFetcher).toHaveBeenCalledWith(Object.assign(Object.assign({}, args), { headers: {
                        "X-Existing": "header",
                        "Auth0-Custom-Domain": "auth.example.com",
                    } }));
            }));
            it("should chain with existing custom fetcher for non-whitelisted paths", () => __awaiter(void 0, void 0, void 0, function* () {
                const mockCustomFetcher = jest.fn().mockResolvedValue({
                    ok: true,
                    body: { data: "custom-result" },
                    headers: {},
            ...
            it("should use core fetcher when no custom fetcher is provided", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("helper function combinations", () => {
        it("should combine multiple helpers correctly", () => {
            const combined = Object.assign(Object.assign(Object.assign(Object.assign({}, CustomDomainHeader("auth.example.com")), withTimeout(30)), withRetries(3)), withHeaders({
                "X-Request-ID": "test-123",
            }));
        ...
        it("should handle header merging when using spread syntax", () => {
            ...
            const combined = Object.assign(Object.assign(Object.assign(Object.assign({}, customDomain), withTimeout(30)), withRetries(3)), { headers: Object.assign(Object.assign({}, customDomain.headers), customHeaders.headers) });
            expect(combined).toEqual({
                headers: {
                    "Auth0-Custom-Domain": "auth.example.com",
                    "X-Request-ID": "test-123",
        ...
        it("should handle header conflicts by using last one", () => {
            const combined = Object.assign(Object.assign({}, CustomDomainHeader("auth.example.com")), withHeaders({
