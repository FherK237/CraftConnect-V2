...
import { Rendering } from "../resources/rendering/client/Client.mjs";
import { CustomText } from "../resources/customText/client/Client.mjs";
import { Partials } from "../resources/partials/client/Client.mjs";
export class Prompts {
    ...
    get rendering() {
        var _a;
        return ((_a = this._rendering) !== null && _a !== void 0 ? _a : (this._rendering = new Rendering(this._options)));
    }
    get customText() {
        var _a;
    ...
    get partials() {
        var _a;
        return ((_a = this._partials) !== null && _a !== void 0 ? _a : (this._partials = new Partials(this._options)));
    }
    /**
