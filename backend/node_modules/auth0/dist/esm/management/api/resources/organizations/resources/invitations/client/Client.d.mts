...
export declare class Invitations {
     ...
     */
    list(id: string, request?: Management.ListOrganizationInvitationsRequestParameters, requestOptions?: Invitations.RequestOptions): Promise<core.Page<Management.OrganizationInvitation>>;
    /**
     ...
     *     })
     */
    create(id: string, request: Management.CreateOrganizationInvitationRequestContent, requestOptions?: Invitations.RequestOptions): core.HttpResponsePromise<Management.CreateOrganizationInvitationResponseContent>;
    private __create;
    /**
     * @param {string} id - Organization identifier.
     ...
     */
    get(id: string, invitationId: string, request?: Management.GetOrganizationInvitationRequestParameters, requestOptions?: Invitations.RequestOptions): core.HttpResponsePromise<Management.GetOrganizationInvitationResponseContent>;
    private __get;
    /**
     * @param {string} id - Organization identifier.
     * @param {string} invitationId - The id of the user invitation.
     ...
     */
    delete(id: string, invitationId: string, requestOptions?: Invitations.RequestOptions): core.HttpResponsePromise<void>;
    private __delete;
