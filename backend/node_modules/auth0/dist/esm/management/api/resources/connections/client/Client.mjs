...
import { Clients } from "../resources/clients/client/Client.mjs";
import { Keys } from "../resources/keys/client/Client.mjs";
import { ScimConfiguration } from "../resources/scimConfiguration/client/Client.mjs";
...
export class Connections {
    ...
    get scimConfiguration() {
        var _a;
        return ((_a = this._scimConfiguration) !== null && _a !== void 0 ? _a : (this._scimConfiguration = new ScimConfiguration(this._options)));
    }
    get users() {
        var _a;
