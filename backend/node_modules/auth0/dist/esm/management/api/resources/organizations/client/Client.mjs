...
import { ClientGrants } from "../resources/clientGrants/client/Client.mjs";
import { EnabledConnections } from "../resources/enabledConnections/client/Client.mjs";
import { Invitations } from "../resources/invitations/client/Client.mjs";
import { Members } from "../resources/members/client/Client.mjs";
export class Organizations {
    ...
    get enabledConnections() {
        var _a;
        return ((_a = this._enabledConnections) !== null && _a !== void 0 ? _a : (this._enabledConnections = new EnabledConnections(this._options)));
    }
    get invitations() {
        var _a;
        return ((_a = this._invitations) !== null && _a !== void 0 ? _a : (this._invitations = new Invitations(this._options)));
    }
    get members() {
        var _a;
        return ((_a = this._members) !== null && _a !== void 0 ? _a : (this._members = new Members(this._options)));
    }
    /**
