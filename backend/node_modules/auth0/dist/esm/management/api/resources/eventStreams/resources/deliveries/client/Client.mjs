...
export class Deliveries {
    ...
    __list(id_1) {
        return __awaiter(this, arguments, void 0, function* (id, request = {}, requestOptions) {
            ...
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, `event-streams/${encodeURIComponent(id)}/deliveries`),
                method: "GET",
                headers: _headers,
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling GET /event-streams/{id}/deliveries.");
                case "unknown":
                    throw new errors.ManagementError({
     ...
     */
    getHistory(id, eventId, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__getHistory(id, eventId, requestOptions));
    }
    __getHistory(id, eventId, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
            let _headers = mergeHeaders((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, mergeOnlyDefinedHeaders({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, `event-streams/${encodeURIComponent(id)}/deliveries/${encodeURIComponent(eventId)}`),
                method: "GET",
                headers: _headers,
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling GET /event-streams/{id}/deliveries/{event_id}.");
                case "unknown":
                    throw new errors.ManagementError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
