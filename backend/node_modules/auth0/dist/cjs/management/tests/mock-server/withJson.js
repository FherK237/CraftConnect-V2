 ...
 */
function withJson(expectedBody, resolver) {
    return (args) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            actualBody = (0, json_js_1.fromJson)(bodyText);
        }
        catch (error) {
        ...
        if (Object.keys(mismatches).filter((key) => !key.startsWith("pagination.")).length > 0) {
            console.error("JSON body mismatch:", (0, json_js_1.toJson)(mismatches, undefined, 2));
            return (0, msw_1.passthrough)();
        }
