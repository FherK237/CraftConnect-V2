...
describe("Settings", () => {
    test("get (e4f93e66)", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const response = yield client.tenants.settings.get();
    ...
    test("update (8969b2c1)", () => __awaiter(void 0, void 0, void 0, function* () {
        const server = MockServerPool_js_1.mockServerPool.createServer();
        const client = new Client_js_1.ManagementClient({ token: "test", environment: server.baseUrl });
        ...
        server
            ...
            .build();
        const response = yield client.tenants.settings.update();
        expect(response).toEqual({
            change_password: {
                enabled: true,
                html: "html",
    ...
    test("update (c3027d90)", () => __awaiter(void 0, void 0, void 0, function* () {
        const server = MockServerPool_js_1.mockServerPool.createServer();
        const client = new Client_js_1.ManagementClient({ token: "test", environment: server.baseUrl });
        const rawRequestBody = {
        ...
        server
            ...
            .build();
        yield expect(() => __awaiter(void 0, void 0, void 0, function* () {
            return yield client.tenants.settings.update({
                change_password: undefined,
                device_flow: undefined,
                guardian_mfa_page: undefined,
                default_audience: undefined,
    ...
    test("update (967318b8)", () => __awaiter(void 0, void 0, void 0, function* () {
        const server = MockServerPool_js_1.mockServerPool.createServer();
        const client = new Client_js_1.ManagementClient({ token: "test", environment: server.baseUrl });
        const rawRequestBody = {
            change_password: undefined,
    ...
    test("update (ad473ebc)", () => __awaiter(void 0, void 0, void 0, function* () {
        const server = MockServerPool_js_1.mockServerPool.createServer();
        const client = new Client_js_1.ManagementClient({ token: "test", environment: server.baseUrl });
        const rawRequestBody = {
            change_password: undefined,
    ...
    test("update (5524f088)", () => __awaiter(void 0, void 0, void 0, function* () {
        const server = MockServerPool_js_1.mockServerPool.createServer();
        const client = new Client_js_1.ManagementClient({ token: "test", environment: server.baseUrl });
        const rawRequestBody = {
            change_password: undefined,
