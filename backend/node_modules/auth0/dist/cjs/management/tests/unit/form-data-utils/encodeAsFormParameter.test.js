...
const encodeAsFormParameter_js_1 = require("../../../../../src/management/core/form-data-utils/encodeAsFormParameter.js");
describe("encodeAsFormParameter", () => {
    describe("Basic functionality", () => {
        it("should return empty object for null/undefined", () => {
            expect((0, encodeAsFormParameter_js_1.encodeAsFormParameter)(null)).toEqual({});
            expect((0, encodeAsFormParameter_js_1.encodeAsFormParameter)(undefined)).toEqual({});
        });
        it("should return empty object for primitive values", () => {
            expect((0, encodeAsFormParameter_js_1.encodeAsFormParameter)("hello")).toEqual({});
            expect((0, encodeAsFormParameter_js_1.encodeAsFormParameter)(42)).toEqual({});
            expect((0, encodeAsFormParameter_js_1.encodeAsFormParameter)(true)).toEqual({});
        });
        it("should handle simple key-value pairs", () => {
            const obj = { name: "John", age: 30 };
            expect((0, encodeAsFormParameter_js_1.encodeAsFormParameter)(obj)).toEqual({
                name: "John",
                age: "30",
            });
        });
        it("should handle empty objects", () => {
            expect((0, encodeAsFormParameter_js_1.encodeAsFormParameter)({})).toEqual({});
        });
    });
    ...
    describe("Special characters and encoding", () => {
        ...
        it("should handle ampersand and equals characters (edge case)", () => {
            ...
            const result = (0, encodeAsFormParameter_js_1.encodeAsFormParameter)(obj);
    ...
    describe("Form data specific scenarios", () => {
        it("should handle file upload metadata", () => {
            ...
            expect((0, encodeAsFormParameter_js_1.encodeAsFormParameter)(metadata)).toEqual({
        ...
        it("should handle form validation data", () => {
            ...
            expect((0, encodeAsFormParameter_js_1.encodeAsFormParameter)(formData)).toEqual({
                "fields[0]": "name",
                "fields[1]": "email",
                "fields[2]": "phone",
        ...
        it("should handle search/filter parameters", () => {
            ...
            expect((0, encodeAsFormParameter_js_1.encodeAsFormParameter)(searchParams)).toEqual({
    ...
    describe("Integration with form submission", () => {
        it("should produce form-compatible key-value pairs", () => {
            ...
            const result = (0, encodeAsFormParameter_js_1.encodeAsFormParameter)(formObject);
        ...
        it("should handle complex nested arrays for API parameters", () => {
            ...
            const result = (0, encodeAsFormParameter_js_1.encodeAsFormParameter)(apiParams);
            expect(result).toEqual({
    ...
    describe("Error cases and malformed input", () => {
        it("should handle circular references gracefully", () => {
            ...
            expect(() => (0, encodeAsFormParameter_js_1.encodeAsFormParameter)(obj)).toThrow("Maximum call stack size exceeded");
        });
        it("should handle very deeply nested objects", () => {
            ...
            expect(() => (0, encodeAsFormParameter_js_1.encodeAsFormParameter)(deepObj)).not.toThrow();
            const result = (0, encodeAsFormParameter_js_1.encodeAsFormParameter)(deepObj);
            expect(Object.keys(result).length).toBeGreaterThan(0);
        });
        it("should handle empty string splitting edge case", () => {
            // Test what happens when qs returns an empty string
            const result = (0, encodeAsFormParameter_js_1.encodeAsFormParameter)({});
            expect(result).toEqual({});
        });
    });
});
