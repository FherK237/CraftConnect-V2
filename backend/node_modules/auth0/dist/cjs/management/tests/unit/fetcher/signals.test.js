...
const signals_js_1 = require("../../../../../src/management/core/fetcher/signals.js");
describe("Test getTimeoutSignal", () => {
    ...
    it("should return an object with signal and abortId", () => {
        const { signal, abortId } = (0, signals_js_1.getTimeoutSignal)(1000);
    ...
    it("should create a signal that aborts after the specified timeout", () => {
        ...
        const { signal } = (0, signals_js_1.getTimeoutSignal)(timeoutMs);
        expect(signal.aborted).toBe(false);
...
describe("Test anySignal", () => {
    it("should return an AbortSignal", () => {
        const signal = (0, signals_js_1.anySignal)(new AbortController().signal);
        expect(signal).toBeInstanceOf(AbortSignal);
    });
    it("should abort when any of the input signals is aborted", () => {
        const controller1 = new AbortController();
        const controller2 = new AbortController();
        const signal = (0, signals_js_1.anySignal)(controller1.signal, controller2.signal);
        expect(signal.aborted).toBe(false);
        controller1.abort();
        expect(signal.aborted).toBe(true);
    });
