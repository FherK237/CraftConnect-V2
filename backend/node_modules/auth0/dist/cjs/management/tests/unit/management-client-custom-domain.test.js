...
const ManagementClient_js_1 = require("../../wrapper/ManagementClient.js");
describe("ManagementClient with custom domain header", () => {
    ...
    describe("constructor", () => {
        it("should create client without custom domain header", () => {
            const client = new ManagementClient_js_1.ManagementClient(mockConfig);
            expect(client).toBeInstanceOf(ManagementClient_js_1.ManagementClient);
        });
        it("should create client with custom domain header", () => {
            const clientWithCustomDomain = new ManagementClient_js_1.ManagementClient(Object.assign(Object.assign({}, mockConfig), { withCustomDomainHeader: "auth.example.com" }));
            expect(clientWithCustomDomain).toBeInstanceOf(ManagementClient_js_1.ManagementClient);
        });
        it("should handle client credentials with custom domain header", () => {
            ...
            const client = new ManagementClient_js_1.ManagementClient(clientCredentialsConfig);
            expect(client).toBeInstanceOf(ManagementClient_js_1.ManagementClient);
        });
        it("should handle client assertion with custom domain header", () => {
            ...
            const client = new ManagementClient_js_1.ManagementClient(clientAssertionConfig);
            expect(client).toBeInstanceOf(ManagementClient_js_1.ManagementClient);
        });
    });
    describe("telemetry integration", () => {
        it("should preserve telemetry when using custom domain header", () => {
            const client = new ManagementClient_js_1.ManagementClient(Object.assign(Object.assign({}, mockConfig), { withCustomDomainHeader: "auth.example.com", telemetry: true, clientInfo: { name: "test-client", version: "1.0.0" } }));
            expect(client).toBeInstanceOf(ManagementClient_js_1.ManagementClient);
        });
        it("should work with telemetry disabled and custom domain header", () => {
            const client = new ManagementClient_js_1.ManagementClient(Object.assign(Object.assign({}, mockConfig), { withCustomDomainHeader: "auth.example.com", telemetry: false }));
            expect(client).toBeInstanceOf(ManagementClient_js_1.ManagementClient);
        });
    });
    describe("configuration validation", () => {
        it("should throw error for invalid custom domain header", () => {
            expect(() => {
                new ManagementClient_js_1.ManagementClient(Object.assign(Object.assign({}, mockConfig), { withCustomDomainHeader: "" }));
        ...
        it("should trim and accept valid custom domain header", () => {
            const client = new ManagementClient_js_1.ManagementClient(Object.assign(Object.assign({}, mockConfig), { withCustomDomainHeader: "  auth.example.com  " }));
            expect(client).toBeInstanceOf(ManagementClient_js_1.ManagementClient);
        });
    });
    describe("options forwarding", () => {
        it("should forward all base options to underlying client", () => {
            const extendedConfig = Object.assign(Object.assign({}, mockConfig), { withCustomDomainHeader: "auth.example.com", maxRetries: 5, timeoutInSeconds: 30, headers: {
                    "X-Custom": "value",
                } });
            const client = new ManagementClient_js_1.ManagementClient(extendedConfig);
            expect(client).toBeInstanceOf(ManagementClient_js_1.ManagementClient);
        });
        it("should handle audience parameter correctly", () => {
            ...
            const client = new ManagementClient_js_1.ManagementClient(configWithAudience);
            expect(client).toBeInstanceOf(ManagementClient_js_1.ManagementClient);
        });
        it("should handle mTLS configuration", () => {
            ...
            const client = new ManagementClient_js_1.ManagementClient(configWithMTLS);
            expect(client).toBeInstanceOf(ManagementClient_js_1.ManagementClient);
        });
    });
    describe("type safety", () => {
        it("should accept valid token-based configuration", () => {
            ...
            const client = new ManagementClient_js_1.ManagementClient(tokenConfig);
            expect(client).toBeInstanceOf(ManagementClient_js_1.ManagementClient);
        });
        it("should accept valid client secret configuration", () => {
            ...
            const client = new ManagementClient_js_1.ManagementClient(clientSecretConfig);
            expect(client).toBeInstanceOf(ManagementClient_js_1.ManagementClient);
        });
    ...
    describe("custom fetcher integration", () => {
        it("should work with both custom fetcher and custom domain header", () => {
            ...
            const client = new ManagementClient_js_1.ManagementClient(Object.assign(Object.assign({}, mockConfig), { withCustomDomainHeader: "auth.example.com", fetcher: mockCustomFetcher }));
            expect(client).toBeInstanceOf(ManagementClient_js_1.ManagementClient);
        });
        it("should create client with custom fetcher but without custom domain header", () => {
            ...
            // TODO: Casting to any to bypass type checks for testing purposes.
            // This is done only because the fetcher type is being hidden for now.
            const client = new ManagementClient_js_1.ManagementClient(Object.assign(Object.assign({}, mockConfig), { fetcher: mockCustomFetcher }));
            expect(client).toBeInstanceOf(ManagementClient_js_1.ManagementClient);
        });
    });
});
