...
const setObjectProperty_js_1 = require("../../../../../src/management/core/utils/setObjectProperty.js");
describe("Test setObjectProperty", () => {
    ...
    test.each(testCases)("$description", ({ giveObject, givePath, giveValue, wantObject }) => {
        const result = (0, setObjectProperty_js_1.setObjectProperty)(giveObject, givePath, giveValue);
