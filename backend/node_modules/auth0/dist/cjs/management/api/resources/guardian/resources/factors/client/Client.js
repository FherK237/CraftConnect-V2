...
const Client_js_1 = require("../resources/phone/client/Client.js");
const Client_js_2 = require("../resources/pushNotification/client/Client.js");
const Client_js_3 = require("../resources/sms/client/Client.js");
const Client_js_4 = require("../resources/duo/client/Client.js");
class Factors {
    ...
    get phone() {
        var _a;
        return ((_a = this._phone) !== null && _a !== void 0 ? _a : (this._phone = new Client_js_1.Phone(this._options)));
    }
    get pushNotification() {
        var _a;
        return ((_a = this._pushNotification) !== null && _a !== void 0 ? _a : (this._pushNotification = new Client_js_2.PushNotification(this._options)));
    }
    get sms() {
        var _a;
        return ((_a = this._sms) !== null && _a !== void 0 ? _a : (this._sms = new Client_js_3.Sms(this._options)));
    }
    get duo() {
        var _a;
        return ((_a = this._duo) !== null && _a !== void 0 ? _a : (this._duo = new Client_js_4.Duo(this._options)));
    }
    /**
    ...
    __list(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, "guardian/factors"),
                method: "GET",
                headers: _headers,
    ...
    __set(name, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let _headers = (0, headers_js_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_js_1.mergeOnlyDefinedHeaders)({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, `guardian/factors/${encodeURIComponent(name)}`),
                method: "PUT",
                headers: _headers,
