...
const Client_js_1 = require("../resources/rendering/client/Client.js");
const Client_js_2 = require("../resources/customText/client/Client.js");
const Client_js_3 = require("../resources/partials/client/Client.js");
class Prompts {
    ...
    get rendering() {
        var _a;
        return ((_a = this._rendering) !== null && _a !== void 0 ? _a : (this._rendering = new Client_js_1.Rendering(this._options)));
    }
    get customText() {
        var _a;
        return ((_a = this._customText) !== null && _a !== void 0 ? _a : (this._customText = new Client_js_2.CustomText(this._options)));
    }
    get partials() {
        var _a;
        return ((_a = this._partials) !== null && _a !== void 0 ? _a : (this._partials = new Client_js_3.Partials(this._options)));
    }
    /**
    ...
    __getSettings(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, "prompts"),
                method: "GET",
                headers: _headers,
