...
exports.SuspiciousIpThrottling = void 0;
    ...
    __get(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, "attack-protection/suspicious-ip-throttling"),
                method: "GET",
                headers: _headers,
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling GET /attack-protection/suspicious-ip-throttling.");
                case "unknown":
                    throw new errors.ManagementError({
    ...
    __update() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling PATCH /attack-protection/suspicious-ip-throttling.");
                case "unknown":
                    throw new errors.ManagementError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
...
exports.SuspiciousIpThrottling = SuspiciousIpThrottling;
