...
const Client_js_2 = require("../resources/themes/client/Client.js");
const Client_js_3 = require("../resources/phone/client/Client.js");
class Branding {
    ...
    get templates() {
        var _a;
        return ((_a = this._templates) !== null && _a !== void 0 ? _a : (this._templates = new Client_js_1.Templates(this._options)));
    }
    get themes() {
        var _a;
        return ((_a = this._themes) !== null && _a !== void 0 ? _a : (this._themes = new Client_js_2.Themes(this._options)));
    }
    get phone() {
        var _a;
        return ((_a = this._phone) !== null && _a !== void 0 ? _a : (this._phone = new Client_js_3.Phone(this._options)));
    }
    /**
