...
const Client_js_1 = require("../resources/newDevice/client/Client.js");
class Settings {
    ...
    get newDevice() {
        var _a;
        return ((_a = this._newDevice) !== null && _a !== void 0 ? _a : (this._newDevice = new Client_js_1.NewDevice(this._options)));
    }
    /**
    ...
    __get(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, "risk-assessments/settings"),
                method: "GET",
                headers: _headers,
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling GET /risk-assessments/settings.");
                case "unknown":
                    throw new errors.ManagementError({
    ...
    __update(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling PATCH /risk-assessments/settings.");
                case "unknown":
                    throw new errors.ManagementError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
