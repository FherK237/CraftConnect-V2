...
const Client_js_1 = require("../resources/bindings/client/Client.js");
class Triggers {
    ...
    get bindings() {
        var _a;
        return ((_a = this._bindings) !== null && _a !== void 0 ? _a : (this._bindings = new Client_js_1.Bindings(this._options)));
    }
    /**
    ...
    __list(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, "actions/triggers"),
                method: "GET",
                headers: _headers,
