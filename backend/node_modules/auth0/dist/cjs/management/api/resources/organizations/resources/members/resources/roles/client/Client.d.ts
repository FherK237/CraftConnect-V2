...
export declare class Roles {
     ...
     */
    list(id: string, userId: string, request?: Management.ListOrganizationMemberRolesRequestParameters, requestOptions?: Roles.RequestOptions): Promise<core.Page<Management.Role>>;
    /**
     ...
     *     })
     */
    assign(id: string, userId: string, request: Management.AssignOrganizationMemberRolesRequestContent, requestOptions?: Roles.RequestOptions): core.HttpResponsePromise<void>;
    private __assign;
    /**
     ...
     *     })
     */
    delete(id: string, userId: string, request: Management.DeleteOrganizationMemberRolesRequestContent, requestOptions?: Roles.RequestOptions): core.HttpResponsePromise<void>;
    private __delete;
