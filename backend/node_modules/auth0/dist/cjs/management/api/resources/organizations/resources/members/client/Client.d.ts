...
export declare class Members {
     ...
     */
    list(id: string, request?: Management.ListOrganizationMembersRequestParameters, requestOptions?: Members.RequestOptions): Promise<core.Page<Management.OrganizationMember>>;
    /**
     ...
     *     })
     */
    create(id: string, request: Management.CreateOrganizationMemberRequestContent, requestOptions?: Members.RequestOptions): core.HttpResponsePromise<void>;
    private __create;
    /**
     * @param {string} id - Organization identifier.
     ...
     *     })
     */
    delete(id: string, request: Management.DeleteOrganizationMembersRequestContent, requestOptions?: Members.RequestOptions): core.HttpResponsePromise<void>;
    private __delete;
