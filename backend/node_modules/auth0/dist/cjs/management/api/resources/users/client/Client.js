...
const Client_js_3 = require("../resources/enrollments/client/Client.js");
const Client_js_4 = require("../resources/federatedConnectionsTokensets/client/Client.js");
const Client_js_5 = require("../resources/groups/client/Client.js");
...
const Client_js_11 = require("../resources/riskAssessments/client/Client.js");
const Client_js_12 = require("../resources/roles/client/Client.js");
const Client_js_13 = require("../resources/refreshToken/client/Client.js");
...
class Users {
    ...
    get authenticationMethods() {
        var _a;
        return ((_a = this._authenticationMethods) !== null && _a !== void 0 ? _a : (this._authenticationMethods = new Client_js_1.AuthenticationMethods(this._options)));
    }
    get authenticators() {
        var _a;
        return ((_a = this._authenticators) !== null && _a !== void 0 ? _a : (this._authenticators = new Client_js_2.Authenticators(this._options)));
    }
    get enrollments() {
        var _a;
        return ((_a = this._enrollments) !== null && _a !== void 0 ? _a : (this._enrollments = new Client_js_3.Enrollments(this._options)));
    }
    get federatedConnectionsTokensets() {
        var _a;
        return ((_a = this._federatedConnectionsTokensets) !== null && _a !== void 0 ? _a : (this._federatedConnectionsTokensets = new Client_js_4.FederatedConnectionsTokensets(this._options)));
    }
    get groups() {
        var _a;
        return ((_a = this._groups) !== null && _a !== void 0 ? _a : (this._groups = new Client_js_5.Groups(this._options)));
    }
    get identities() {
        var _a;
        return ((_a = this._identities) !== null && _a !== void 0 ? _a : (this._identities = new Client_js_6.Identities(this._options)));
    }
    get logs() {
        var _a;
        return ((_a = this._logs) !== null && _a !== void 0 ? _a : (this._logs = new Client_js_7.Logs(this._options)));
    }
    get multifactor() {
        var _a;
        return ((_a = this._multifactor) !== null && _a !== void 0 ? _a : (this._multifactor = new Client_js_8.Multifactor(this._options)));
    }
    get organizations() {
        var _a;
        return ((_a = this._organizations) !== null && _a !== void 0 ? _a : (this._organizations = new Client_js_9.Organizations(this._options)));
    }
    get permissions() {
        var _a;
        return ((_a = this._permissions) !== null && _a !== void 0 ? _a : (this._permissions = new Client_js_10.Permissions(this._options)));
    }
    get riskAssessments() {
        var _a;
        return ((_a = this._riskAssessments) !== null && _a !== void 0 ? _a : (this._riskAssessments = new Client_js_11.RiskAssessments(this._options)));
    }
    get roles() {
        var _a;
        return ((_a = this._roles) !== null && _a !== void 0 ? _a : (this._roles = new Client_js_12.Roles(this._options)));
    }
    get refreshToken() {
        var _a;
        return ((_a = this._refreshToken) !== null && _a !== void 0 ? _a : (this._refreshToken = new Client_js_13.RefreshToken(this._options)));
    }
    get sessions() {
        var _a;
        return ((_a = this._sessions) !== null && _a !== void 0 ? _a : (this._sessions = new Client_js_14.Sessions(this._options)));
    }
    /**
    ...
    list() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            return new core.Pageable({
                ...
                hasNextPage: (response) => { var _a; return ((_a = response === null || response === void 0 ? void 0 : response.users) !== null && _a !== void 0 ? _a : []).length > 0; },
    ...
    __listUsersByEmail(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let _headers = (0, headers_js_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_js_1.mergeOnlyDefinedHeaders)({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, "users-by-email"),
                method: "GET",
                headers: _headers,
                queryParameters: Object.assign(Object.assign({}, _queryParams), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams),
                timeoutMs: (requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeoutInSeconds) != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
    ...
    __get(id_1) {
        return __awaiter(this, arguments, void 0, function* (id, request = {}, requestOptions) {
            ...
            let _headers = (0, headers_js_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_js_1.mergeOnlyDefinedHeaders)({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, `users/${encodeURIComponent(id)}`),
                method: "GET",
                headers: _headers,
                queryParameters: Object.assign(Object.assign({}, _queryParams), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams),
                timeoutMs: (requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeoutInSeconds) != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
    ...
    __regenerateRecoveryCode(id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let _headers = (0, headers_js_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_js_1.mergeOnlyDefinedHeaders)({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, `users/${encodeURIComponent(id)}/recovery-code-regeneration`),
                method: "POST",
                headers: _headers,
                queryParameters: requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams,
                timeoutMs: (requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeoutInSeconds) != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
    ...
    __revokeAccess(id_1) {
        return __awaiter(this, arguments, void 0, function* (id, request = {}, requestOptions) {
            ...
            let _headers = (0, headers_js_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_js_1.mergeOnlyDefinedHeaders)({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, `users/${encodeURIComponent(id)}/revoke-access`),
                method: "POST",
                headers: _headers,
                contentType: "application/json",
                queryParameters: requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams,
