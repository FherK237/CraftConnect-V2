...
export declare namespace UpdateBruteForceSettingsResponseContent {
    type Shields = Shields.Item[];
    namespace Shields {
        type Item = "block" | "user_notification";
        const Item: {
     ...
     *           Possible values: <code>count_per_identifier_and_ip</code>, <code>count_per_identifier</code>.
     */
    type Mode = "count_per_identifier_and_ip" | "count_per_identifier";
    const Mode: {
